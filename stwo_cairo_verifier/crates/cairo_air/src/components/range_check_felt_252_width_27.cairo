...
pub const RELATION_USES_PER_ROW: [(felt252, u32); 2] = [
    ('RangeCheck_9_9', 5), ('RangeCheck_18', 9),
];
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_18_sum_4: QM31 = Zero::zero();
        ...
        let mut range_check_18_sum_10: QM31 = Zero::zero();
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_range_check_felt_252_width_27_dummy_sum() {
        let claim = Claim {
            log_size: 3,
        };
        ...
        let component = Component {
            claim,
            interaction_claim,
            range_check_9_9_lookup_elements: dummy_lookup_elements::<2>(),
            range_check_18_lookup_elements: dummy_lookup_elements::<1>(),
        ...
        println!("Dummy sum for range_check_felt_252_width_27: {}", sum);
    }
}
