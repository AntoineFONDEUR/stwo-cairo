...
use crate::components::{CairoComponent, RANGE_CHECK_12_LOG_SIZE};

pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_SIZE: u32 = RANGE_CHECK_12_LOG_SIZE;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_12_sum_0: QM31 = Zero::zero();
        ...
        range_check_12_sum_0 = self.range_check_12_lookup_elements.combine_qm31([seq]);
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_range_check_12_dummy_sum() {
        let claim = Claim {};
        ...
        let component = Component {
            claim,
            interaction_claim,
            range_check_12_lookup_elements: dummy_lookup_elements::<1>(),
        };
        ...
        println!("Dummy sum for range_check_12: {}", sum);
    }
}
