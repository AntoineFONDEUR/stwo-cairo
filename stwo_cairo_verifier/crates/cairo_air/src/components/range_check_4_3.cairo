...
use crate::components::{CairoComponent, RANGE_CHECK_4_3_LOG_SIZE};

pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_SIZE: u32 = RANGE_CHECK_4_3_LOG_SIZE;
...
pub impl ComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(PreprocessedColumn::RangeCheck2(([4, 3], 0)));
        preprocessed_column_set.insert(PreprocessedColumn::RangeCheck2(([4, 3], 1)));
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_4_3_sum_0: QM31 = Zero::zero();
        let rangecheck_4_3_0 = preprocessed_mask_values
            .get(PreprocessedColumn::RangeCheck2(([4, 3], 0)));
        let rangecheck_4_3_1 = preprocessed_mask_values
            .get(PreprocessedColumn::RangeCheck2(([4, 3], 1)));
        ...
        range_check_4_3_sum_0 = self
            .range_check_4_3_lookup_elements
            .combine_qm31([rangecheck_4_3_0, rangecheck_4_3_1]);
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_range_check_4_3_dummy_sum() {
        let claim = Claim {};
        ...
        let component = Component {
            claim,
            interaction_claim,
            range_check_4_3_lookup_elements: dummy_lookup_elements::<2>(),
        };
        ...
        println!("Dummy sum for range_check_4_3: {}", sum);
    }
}
