...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_poseidon_3_partial_rounds_chain_dummy_sum() {
        let claim = Claim {
            log_size: 3,
        };
        ...
        let component = Component {
            claim,
            interaction_claim,
            poseidon_round_keys_lookup_elements: dummy_lookup_elements::<31>(),
        ...
        println!("Dummy sum for poseidon_3_partial_rounds_chain: {}", sum);
    }
}
