...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_pedersen_builtin_dummy_sum() {
        let claim = Claim {
            log_size: 4,
            pedersen_builtin_segment_start: 3,
        };
        ...
        let component = Component {
            ...
            partial_ec_mul_lookup_elements: dummy_lookup_elements::<73>(),
        };
        ...
        println!("Dummy sum for pedersen_builtin: {}", sum);
    }
}
