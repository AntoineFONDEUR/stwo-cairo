...
use crate::components::{CairoComponent, RANGE_CHECK_3_3_3_3_3_LOG_SIZE};
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_range_check_3_3_3_3_3_dummy_sum() {
        let claim = Claim {};
        ...
        println!("Dummy sum for range_check_3_3_3_3_3: {}", sum);
    }
}
