...
use crate::components::{CairoComponent, RANGE_CHECK_5_4_LOG_SIZE};

pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_SIZE: u32 = RANGE_CHECK_5_4_LOG_SIZE;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        range_check_5_4_sum_0 = self
            .range_check_5_4_lookup_elements
            .combine_qm31([rangecheck_5_4_0, rangecheck_5_4_1]);
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_range_check_5_4_dummy_sum() {
        let claim = Claim {};
        ...
        let component = Component {
            claim,
            interaction_claim,
            range_check_5_4_lookup_elements: dummy_lookup_elements::<2>(),
        };
        ...
        println!("Dummy sum for range_check_5_4: {}", sum);
    }
}
