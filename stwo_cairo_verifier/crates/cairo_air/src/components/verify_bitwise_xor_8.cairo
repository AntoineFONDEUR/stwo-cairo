...
use crate::components::{CairoComponent, VERIFY_BITWISE_XOR_8_LOG_SIZE};
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let bitwisexor_8_0 = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((8, 0)));
        let bitwisexor_8_1 = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((8, 1)));
        let bitwisexor_8_2 = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((8, 2)));
        ...
        verify_bitwise_xor_8_sum_0 = self
            ...
            .combine_qm31([bitwisexor_8_0, bitwisexor_8_1, bitwisexor_8_2]);
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_verify_bitwise_xor_8_dummy_sum() {
        let claim = Claim {};
        ...
        let component = Component {
            claim,
            interaction_claim,
            verify_bitwise_xor_8_lookup_elements: dummy_lookup_elements::<3>(),
        };
        ...
        println!("Dummy sum for verify_bitwise_xor_8: {}", sum);
    }
}
