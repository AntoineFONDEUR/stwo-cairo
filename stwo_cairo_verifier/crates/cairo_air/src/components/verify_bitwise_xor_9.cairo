...
use crate::components::{CairoComponent, VERIFY_BITWISE_XOR_9_LOG_SIZE};

pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_SIZE: u32 = VERIFY_BITWISE_XOR_9_LOG_SIZE;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        verify_bitwise_xor_9_sum_0 = self
            ...
            .combine_qm31([bitwisexor_9_0, bitwisexor_9_1, bitwisexor_9_2]);
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_verify_bitwise_xor_9_dummy_sum() {
        let claim = Claim {};
        ...
        println!("Dummy sum for verify_bitwise_xor_9: {}", sum);
    }
}
