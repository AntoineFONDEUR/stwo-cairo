...
pub impl ClaimImpl of ClaimTrait {
    fn log_sizes(self: @Claim) -> TreeArray<Span<u32>> {
        ...
        let interaction_log_sizes = ArrayImpl::new_repeated(148, log_size).span();
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_blake_compress_opcode_dummy_sum() {
        let claim = Claim {
            log_size: 4,
        };
        ...
        let component = Component {
            ...
            range_check_7_2_5_lookup_elements: dummy_lookup_elements::<3>(),
            verify_bitwise_xor_8_lookup_elements: dummy_lookup_elements::<3>(),
            blake_round_lookup_elements: dummy_lookup_elements::<35>(),
            triple_xor_32_lookup_elements: dummy_lookup_elements::<8>(),
        ...
        println!("Dummy sum for blake_compress_opcode: {}", sum);
    }
}
