...
use crate::components::{CairoComponent, RANGE_CHECK_18_LOG_SIZE};

pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_SIZE: u32 = RANGE_CHECK_18_LOG_SIZE;
...
mod tests {
    ...
    #[test]
    #[cairofmt::skip]
    fn test_range_check_18_dummy_sum() {
        let claim = Claim {};
        ...
        println!("Dummy sum for range_check_18: {}", sum);
    }
}
