...
mod tests {
    ...
    fn test_blake_g_dummy_sum() {
        ...
        let component = Component {
            ...
            verify_bitwise_xor_12_lookup_elements: dummy_lookup_elements::<3>(),
            verify_bitwise_xor_4_lookup_elements: dummy_lookup_elements::<3>(),
            verify_bitwise_xor_7_lookup_elements: dummy_lookup_elements::<3>(),
            verify_bitwise_xor_9_lookup_elements: dummy_lookup_elements::<3>(),
            blake_g_lookup_elements: dummy_lookup_elements::<20>(),
        };
        ...
        println!("Dummy sum for blake_g: {}", sum);
    }
}
